...
<div id="Content1" runat="server" class="cart-wrapper" >
                      ...
                      <div class="cart-product-details">
                       ...
                       <div class="cart-product-details">
                              ...
                              <div class="cart-product-quantity">
                                  <button id="MinusButton"  class="icon-card" onclick="MinusButton_Click(this, event)">
                                  ...
                                  <button id="PlusButton"  class="icon-card" onclick="PlusButton_Click(this, event)">
                                      <span role="img" aria-label="minus" class="anticon anticon-minus">
                                          <svg viewBox="64 64 896 896" focusable="false" data-icon="minus" width="1em" height="1em" fill="currentColor" aria-hidden="true">
                ...
                <asp:TemplateField>            
                    <ItemTemplate >
                        ...
                        <div class="cart-product-details">
                          ...
                          <asp:TextBox type="number" ID="TextBox1" Width="60" runat="server" Text="<%#: Item.Product.UnitPrice %>"></asp:TextBox>
                        </div>   
                    </ItemTemplate>        
                </asp:TemplateField> 
                <asp:TemplateField >            
    ...
    <script type = "text/javascript">
        function PlusButton_Click(elem, e) {
            e.preventDefault();
            $(elem).prev().val(parseInt($(elem).prev().val()) + 1);
        }
        function MinusButton_Click(elem, e) {
            e.preventDefault();
            if (parseInt($(elem).next().val()) === 0) {
                return;
            }
