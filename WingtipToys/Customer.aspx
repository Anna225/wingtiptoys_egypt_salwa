...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="card">
                <div class="search-wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-9 form-group">
                            <input type="search" class="form-control" runat="server" style="width: 100% !important" id="inputSuccess" placeholder="Search Customer by name, email or phone ...">
                ...
                <div class="list">
                    <div class="row">
                        <div class="col-md-12 customer-list-row">
                            <div class="customer-list-details">
                                ...
                                <div>
                                    <span class="customer-icon-card edit" title="Edit Customer">
                                    ...
                                    <span class="customer-icon-card delete" title="Delete Customer">
                                    ...
                                    <span class="customer-icon-card set" title="Current Customer">
                            ...
                            <div class="customer-list-details">
                                <img src="https://secure.gravatar.com/avatar/7f10016b73d8fe56e5fc067558edb9f3?s=96&amp;d=identicon&amp;r=g" alt="dwight">
                                    ...
                                    <div>
                                        ...
                                        <span class="customer-icon-card set" title="Set Customer">
                                            <span role="img" aria-label="check" class="anticon anticon-check">
                                                <svg viewBox="64 64 896 896" focusable="false" data-icon="check" width="1em" height="1em" fill="currentColor" aria-hidden="true">
                                                    <path d="M912 190h-69.9c-9.8 0-19.1 4.5-25.1 12.2L404.7 724.5 207 474a32 32 0 00-25.1-12.2H112c-6.7 0-10.4 7.7-6.3 12.9l273.9 347c12.8 16.2 37.4 16.2 50.3 0l488.4-618.9c4.1-5.1.4-12.8-6.3-12.8z">
                                                    </path>
            ...
            <div class="card">
                ...
                <div class="form w-100" novalidate="novalidate" id="customer-form" action="#">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                <label class="col-form-label" for="inputWarning">First Name</label>
                                <input type="text" class="form-control" id="firstname" placeholder="Enter First Name">
                            </div>
                            <div class="col-md-6">
                                <label class="col-form-label" for="inputWarning">Last Name</label>
                    ...
                    <div class="form-group">
                        <label class="col-form-label" for="inputWarning">Phone</label>
                        <input type="text" data-inputmask="'mask': '(999) 999-9999'" data-mask="" inputmode="text" class="form-control" id="phone" placeholder="Enter Phone Number">
                    </div>
                    <div class="form-group">
                        <label class="col-form-label" for="inputWarning">Address Line1</label>
                        <input type="text" class="form-control" id="address1" placeholder="Enter Address Line1">
                    </div>
                    <div class="form-group">
                        <label class="col-form-label" for="inputWarning">Address Line2</label>
                        <input type="text" class="form-control" id="address2" placeholder="Enter Address Line2">
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                <label class="col-form-label" for="inputWarning">City</label>
                                <input type="text" class="form-control" id="city" placeholder="Enter City">
                            </div>
                            <div class="col-md-6">
                                <label class="col-form-label" for="inputWarning">Postal Code</label>
                                <input type="number" class="form-control" id="postalcode" placeholder="Enter Postal Code">
                            </div>
                        </div> 
                    </div>
                    <div class="form-group-column-2"></div>
                    <button type="button" class="btn btn-block btn-success btn-sm form-control">Save</button>
                </div>
            </div>
          </div>
        </div>
    ...
    <script src="/Content/dist/js/pages/customer.js"></script>
</asp:Content>
